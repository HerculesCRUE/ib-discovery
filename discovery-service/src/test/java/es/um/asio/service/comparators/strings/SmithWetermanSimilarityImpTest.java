...
class SmithWetermanSimilarityImpTest {

    private final Logger logger = LoggerFactory.getLogger(SmithWetermanSimilarityImpTest.class);
    String name = "Smith Weterman Similarity";
    Stats stats;
    ...
    Similarity similarityImp = new SmithWetermanSimilarityImp();
