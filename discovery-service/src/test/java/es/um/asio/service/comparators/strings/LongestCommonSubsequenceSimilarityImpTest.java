...
class LongestCommonSubsequenceSimilarityImpTest {

    private final Logger logger = LoggerFactory.getLogger(LongestCommonSubsequenceSimilarityImpTest.class);
    String name = "Longest Common Subsequence Similarity";
    Stats stats;
    ...
    Similarity similarityImp = new LongestCommonSubsequenceSimilarityImp();
