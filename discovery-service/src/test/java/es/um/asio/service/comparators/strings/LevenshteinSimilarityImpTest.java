...
class LevenshteinSimilarityImpTest {

    private final Logger logger = LoggerFactory.getLogger(LevenshteinSimilarityImpTest.class);
    String name = "Levenshtein Distance Similarity";
    Stats stats;
    ...
    Similarity similarityImp = new LevenshteinSimilarityImp();
