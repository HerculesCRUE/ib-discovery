...
class EuclideanDistanceSimilarityImpTest {

    private final Logger logger = LoggerFactory.getLogger(EuclideanDistanceSimilarityImpTest.class);
    String name = "Euclidean Distance Similarity";
    Stats stats;
    ...
    Similarity similarityImp = new EuclideanDistanceSimilarityImp();
