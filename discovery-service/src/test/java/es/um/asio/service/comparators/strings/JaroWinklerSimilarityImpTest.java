...
class JaroWinklerSimilarityImpTest {

    private final Logger logger = LoggerFactory.getLogger(JaroWinklerSimilarityImpTest.class);
    String name = "Jaro Winkler Similarity";
    Stats stats;
    ...
    Similarity similarityImp = new JaroWinklerSimilarityImp();
