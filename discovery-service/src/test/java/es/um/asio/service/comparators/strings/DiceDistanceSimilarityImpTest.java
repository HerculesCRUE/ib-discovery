...
class DiceDistanceSimilarityImpTest {

    private final Logger logger = LoggerFactory.getLogger(DiceDistanceSimilarityImpTest.class);
    String name = "Dice Distance Similarity";
    Stats stats;
    ...
    Similarity similarityImp = new DiceDistanceSimilarityImp();
