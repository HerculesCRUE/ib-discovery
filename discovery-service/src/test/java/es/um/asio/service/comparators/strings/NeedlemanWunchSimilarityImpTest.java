...
class NeedlemanWunchSimilarityImpTest {

    private final Logger logger = LoggerFactory.getLogger(NeedlemanWunchSimilarityImpTest.class);
    String name = "Needleman Wunch Similarity";
    Stats stats;
    ...
    Similarity similarityImp = new NeedlemanWunchSimilarityImp();
