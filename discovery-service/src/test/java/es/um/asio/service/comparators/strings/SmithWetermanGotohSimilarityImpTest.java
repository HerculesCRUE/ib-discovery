...
class SmithWetermanGotohSimilarityImpTest {

    private final Logger logger = LoggerFactory.getLogger(SmithWetermanGotohSimilarityImpTest.class);
    String name = "Smith Weterman Gotoh Similarity";
    Stats stats;
    ...
    Similarity similarityImp = new SmithWetermanGotohSimilarityImp();
