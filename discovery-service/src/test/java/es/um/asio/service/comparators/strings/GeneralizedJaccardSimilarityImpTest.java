...
class GeneralizedJaccardSimilarityImpTest {
    private final Logger logger = LoggerFactory.getLogger(GeneralizedJaccardSimilarityImpTest.class);
    String name = "Generalized Jaccard Similarity";
    Stats stats;
    ...
    Similarity similarityImp = new GeneralizedJaccardSimilarityImp();
