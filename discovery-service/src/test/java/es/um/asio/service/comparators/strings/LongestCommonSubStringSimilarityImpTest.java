...
class LongestCommonSubStringSimilarityImpTest {

    private final Logger logger = LoggerFactory.getLogger(LongestCommonSubStringSimilarityImpTest.class);
    String name = "Longest Common SubString Similarity";
    Stats stats;
    ...
    Similarity similarityImp = new LongestCommonSubStringSimilarityImp();
