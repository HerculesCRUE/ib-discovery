...
class JaroSimilarityImpTest {
    private final Logger logger = LoggerFactory.getLogger(JaroSimilarityImpTest.class);
    String name = "Jaro Similarity";
    Stats stats;
    ...
    Similarity similarityImp = new JaroSimilarityImp();
