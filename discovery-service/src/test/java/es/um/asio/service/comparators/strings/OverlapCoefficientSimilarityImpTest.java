...
class OverlapCoefficientSimilarityImpTest {

    private final Logger logger = LoggerFactory.getLogger(OverlapCoefficientSimilarityImpTest.class);
    String name = "Overlap Coefficient Similarity";
    Stats stats;
    ...
    Similarity similarityImp = new OverlapCoefficientSimilarityImp();
