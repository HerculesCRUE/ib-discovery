...
class JaccardSimilarityImpTest {
    private final Logger logger = LoggerFactory.getLogger(JaccardSimilarityImpTest.class);
    String name = "Jaccard Similarity";
    Stats stats;
    ...
    Similarity similarityImp = new JaccardSimilarityImp();
