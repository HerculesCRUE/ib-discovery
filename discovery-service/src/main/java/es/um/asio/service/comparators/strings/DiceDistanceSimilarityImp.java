...
/**
 * This class implements the Dice Distance Similarity algorithm to compare Strings
 * @author  Daniel Ruiz Santamaría
 * @version 2.0
 * @since   1.0
 */
public class DiceDistanceSimilarityImp implements Similarity {


    /**
     *
     *  This method calculate the similarity using Dice Distance Algorithm in (0,1) range.
     *  description: The algorithm is based on measuring the edition distance from strings A to string B.
