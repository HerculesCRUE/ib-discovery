...
/**
 * This class implements the similitude of Jaccard Similarity algorithm to compare Strings
...
public class JaccardSimilarityImp implements Similarity {
    ...
    /**
     *
     *  This method calculate the similarity using Jaccard Algorithm in (0,1) range.
     *  description: The algorithm is based on measuring the Jaccard distance from strings A to string B.
