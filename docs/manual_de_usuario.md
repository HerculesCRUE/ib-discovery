...
| Tipo           | Documentación                                                |
| Objetivo       | El presente documento pretende ser un Manual de usuario relativo a el entregable librería de descubrimiento. Para ello, se documentaran exhaustivamente desde un punto de vista de alto nivel, los aspectos funcionales de la librería de descubrimiento. |
| Estado         | Completado                                                   |
| Próximos pasos |                                                              |
| Documentación  | [Librería de descubrimiento](https://github.com/HerculesCRUE/ib-asio-docs-/blob/master/24-Librer%C3%ADa_de_descubrimiento/ASIO_Libreria_de_descubrimiento.md)<br/>[Documentación técnica](./documentacion-tecnica.md) (documentación de bajo nivel)<br/>[Documentación API REST de la librería de descubrimiento](./documentacion_api_rest_de_la_libreria_de_descubrimiento.md) (documentación de bajo nivel)<br/>[README](../README.md)<br/>[docker](./docker.md)<br/>[Federación](https://github.com/HerculesCRUE/ib-discovery<br/>https://github.com/HerculesCRUE/ib-federation<br/>https://github.com/HerculesCRUE/ib-service-discovery)<br/>[Service Discovery](https://github.com/HerculesCRUE/ib-service-discovery) |
...
La librería de descubrimiento, necesita las siguientes herramientas accesibles desde su entorno:

* Redis: Para el almacenamiento en cache
* Elasticsearch: Para la implementación de la reducción del espacio de búsqueda.
* MariaDB: Para almacenamiento de estados, y persistencia de peticiones previas.
* Kafka: Para se usado como bus de comunicaciones y propagar acciones a otros microservicios.
* Zookeeper: Para actuar como broker Kafka.
...
## API REST de la Librería de descubrimiento
...
Por otro lado, puede encontrarse una documentación exhaustiva de los Endpoint desplegados por el API, en el documento [API REST de la librería de descubrimiento](./documentacion_api_rest_de_la_libreria_de_descubrimiento.md)
