...
A partir del proyecto Trellis personalizado para el proyecto [asio-ldp](https://github.com/HerculesCRUE/ib-asio-ldp), es necesario modificar el fichero config-dev.yml (la línea resources para que apunte al Endpoint SPARQL de Fuseki con el dataset del proyecto).
